    ...
    >
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-12 bg-white border-gray-200 text-gray-900 placeholder:text-gray-400 pr-10"
                  required
                />
                <button
                  type="button"
            ...
            <div className="mt-6 space-y-3">
              <a href={loginUrl}>
                <Button
                  type="button"
                  variant="outline"
                  className="w-full h-12 bg-white text-gray-700 border border-gray-200 rounded-lg transition-colors justify-start hover:bg-[#846BD2] hover:text-white hover:border-[#846BD2]"
                >
                  <Building2 className="w-5 h-5 mr-3" />
                  <div className="flex flex-col items-start">
                    <span className="font-medium">Google</span>
                    <span className="text-xs text-gray-500">Use your google corporate account</span>
                  </div>
                </Button>
              </a>
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full h-12 bg-white text-gray-700 border border-gray-200 rounded-lg justify-start transition-colors hover:bg-[#846BD2] hover:text-white hover:border-[#846BD2]"
              >
                <Mail className="w-5 h-5 mr-3" />
                <div className="flex flex-col items-start">
                  <span className="font-medium">Microsoft Active Directory</span>
                  <span className="text-xs text-gray-500">Sign in with your corporate account</span>
                </div>
              </Button>
              ...
              >
                ...
                <div className="flex flex-col items-start">
                  ...
                  <span className="text-xs text-gray-500">Enterprise identity provider</span>
                </div>
              </Button>
            </div>
          </div>
        ...
        >
          ...
          <Card className="bg-white shadow-lg border border-gray-100">
            <CardContent className="p-4 sm:p-6 lg:p-8">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                ...
                <div className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-gray-200 rounded-lg">
                  <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-teal-500" />
                  <span className="text-xs sm:text-sm font-medium text-gray-700">ISO 27001</span>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          {/* Support Contact */}
          <div className="text-center text-xs sm:text-sm text-gray-600 rounded-xl p-4 sm:p-6">
