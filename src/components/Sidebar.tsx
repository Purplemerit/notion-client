...
export const Sidebar = ({ currentView, onViewChange }: SidebarProps) => {
  ...
  const handleThemeToggle = async () => {
    try {
      // Toggle between light and dark (ignore auto for the toggle button)
  ...
  return (
    <div
      className={`inline-flex flex-col items-start flex-shrink-0  sticky top-0 transition-all duration-300 gradient-sidebar border-2 border-gray-200 dark:border-gray-700 ${
        actualTheme === 'dark' ? 'bg-gray-900' : 'bg-[#C9C4EE]'}`}
      style={{
        height: '100vh',
        padding: '24px 0',
        gap: '40px',
          ...
          {!isCollapsed && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold">
                <span className={actualTheme === 'dark' ? 'text-white-500' : 'text-black'}>Purple</span>
                <span className={`ml-1 ${actualTheme === 'dark' ? 'text-purple-500' : 'text-[#FFFFFF]'}`}>Merit</span>
              </span>
...
>
  {isCollapsed ? (
    ...
    >
      <path
        d="M12.4783 6.72065L17.2783 11.5206L12.4783 16.3206M5.75828 6.72065L10.5583 11.5206L5.75828 16.3206"
        stroke="currentColor"
        strokeOpacity="0.8"
        strokeWidth="1.728"
        strokeLinecap="round"
    ...
    >
      <path
        d="M-3.8147e-05 19.44C-3.8147e-05 8.70359 8.68746 3.8147e-06 19.404 3.8147e-06C30.1206 3.8147e-06 28.4121 8.70359 28.4121 19.44C28.4121 30.1764 30.1206 38.88 19.404 38.88C8.68746 38.88 -3.8147e-05 30.1764 -3.8147e-05 19.44Z"
        fill={actualTheme === 'dark' ? '#1F1F1F' : 'white'} 
      />
      <path
        d="M16.3186 24.2407L11.5186 19.4407L16.3186 14.6407M23.0386 24.2407L18.2386 19.4407L23.0386 14.6407"
        stroke="currentColor"
        strokeOpacity="0.8"
        strokeWidth="1.728"
        strokeLinecap="round"
  ...
  New Project
            ...
            {isCollapsed && (
              <Button
                ...
                title="Projects/Team"
              >
                <Users size={18} className={actualTheme === 'dark' ? 'text-white' : 'text-gray-800'} />
              </Button>
            )}
                  ...
                  <div className="ml-9 mt-2 space-y-1">
                    <Button
                      ...
                      className={`justify-center items-center gap-2.5 text-white ${
                        pathname === "/teams"
                          ? "rounded-[20px] shadow-[inset_0_2px_3px_0_rgba(110,76,181,0.38)]"
                          : "text-gray-800 dark:text-gray-200 hover:bg-black/5 dark:hover:bg-white/5 rounded-[20px]"
                      }`}
                      style={
                        pathname === "/teams"
                          ? {
  ...
  Meetings
            ...
            {isCollapsed && (
              <Button
                ...
                title="Calendar"
              >
                <Calendar size={18} className={actualTheme === 'dark' ? 'text-white' : 'text-gray-800'} />
              </Button>
            )}
          </div>
        </div>
        ...
        <div className="space-y-1">
          {accountItems.map((item) =>
            item.id === "settings" ? (
              <div
                key={item.id}
                className={`flex items-center text-gray-800 dark:text-gray-200 ${pathname === '/settings' ? '' : 'hover:bg-black/5 dark:hover:bg-white/5 rounded-[20px]'} justify-between`}
                style={
                  pathname === '/settings'
                    ? {
                        width: isCollapsed ? '48px' : '292px',
    ...
    {item.label}
                ...
                {!isCollapsed && (
                  <button
                    ...
                    className="flex items-center ml-auto cursor-pointer hover:opacity-80 transition-opacity"
              ...
              <Button
                key={item.id}
                variant="ghost"
                className="justify-center items-center gap-2.5 text-gray-800 dark:text-gray-200 hover:bg-black/5 dark:hover:bg-white/5 rounded-[20px]"
                style={{
                  display: 'flex',
                  width: isCollapsed ? '48px' : '292px',
                  padding: '10px',
